...
```{r Q2: Utilization of the intrastructure by passenger/km per capita}
...
```{r Q2+: Utilization of the intrastructure by passenger/km trams only not per capita}
