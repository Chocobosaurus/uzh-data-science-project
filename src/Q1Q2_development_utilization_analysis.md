...
\## The purpose of this question is to compare with the data collected
with other major cities of the world. However, it’s difficult to find
fair comparisons because publicly available data are either Metro only
or not at the level of a single city. Here I tried to make a separate
set of tram only to see how it works.
