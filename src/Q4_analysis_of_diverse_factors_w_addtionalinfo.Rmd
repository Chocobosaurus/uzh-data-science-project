---
title: "NavigatingZH_Data_Science_Intro_UZH_Q4"
author: "Xiaohan Zhu (auxilary info added by Weijia)" 
date: "2024-05-16"
...
## Part 1: <br>
The whole dataset was grouped by factor "Weekday"/"Weekend", or "Semester/Exam period" and the mean across all time points were averaged and visualized as bargraph

```{r Loading data, grouping and visualize gross average}
library(dplyr)
library(readr)
library(ggplot2)
...
### Part 2: <br>
Now perform the same factor analysis with a subset of the data contains only info of stops near universities, visualize with barplot.


```{r Same factor analysis with stops near universities only}
...
```{r same analysis, restricing university stops to ETH/Hongg only for minimal confounder effects}
